...
func buildOrganization(r *rand.Rand, login, enterprise string, w profileWeights, emuEnabled bool) map[string]interface{} {
	...
	settings := map[string]interface{}{
		...
		"security": map[string]interface{}{
			...
			"private_vulnerability_reporting_enabled_for_new_repos": chance(r, w.pushProtectionNewRepos),
		},
	}
	...
	copilot := map[string]interface{}{
		...
		"ide_chat":                pickStringWeighted(r, 0.8, "enabled", "disabled"),
		"platform_chat":           pickStringWeighted(r, 0.6, "enabled", "disabled"),
		"cli":                     pickStringWeighted(r, 0.5, "enabled", "disabled"),
