...
var categoryDisplayNames = map[string]string{
	...
	"ghes_server":         "GHES — Server & Version",
	"ghes_authentication": "GHES — Authentication",
	"ghes_networking":     "GHES — Networking & TLS",
	"ghes_license":        "GHES — License",
	"ghes_infrastructure": "GHES — Infrastructure",
}
