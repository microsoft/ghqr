...
func (e *Evaluator) EvaluateGHESSettings(settings *scanners.GHESSettings, support *scanners.GHESFeatureSupport) *EvaluationResult {
	if settings == nil {
...
func (e *Evaluator) EvaluateGHESInstance(data *scanners.GHESData) *EvaluationResult {
	...
	subResults := []*EvaluationResult{
		...
		e.EvaluateGHESSettings(data.Settings, data.FeatureSupport),
